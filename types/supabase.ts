  ...
  public: {
    Tables: {
      ...
      training_evaluations_admin: {
        ...
        Relationships: [
          {
            foreignKeyName: "training_evaluations_admin_evaluated_by_fkey"
          ...
          {
            foreignKeyName: "training_evaluations_admin_training_id_fkey"
            columns: ["training_id"]
            isOneToOne: false
            referencedRelation: "trainings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "training_evaluations_admin_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "active_volunteers_with_location"
            referencedColumns: ["id"]
