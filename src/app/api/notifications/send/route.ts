...
if (!VAPID_PUBLIC_KEY || !VAPID_PRIVATE_KEY) {
  console.error('[send] ❌ CRITICAL: VAPID keys not configured!')
  ...
  try {
    ...
    console.log('[send] ✅ VAPID configured successfully')
  } catch (error: any) {
    console.error('[send] ❌ Failed to configure VAPID:', error.message)
  }
}
