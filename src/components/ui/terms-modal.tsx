...
export const TermsModal: React.FC<TermsModalProps> = ({ 
  ...
  const setSectionProgress = (section: SectionType) => {
    ...
    if (scrollTop + clientHeight >= sectionBottom - 50) {
      if (section === 'terms') {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        >
          <div ref={termsSectionRef} id="terms-section" className="bg-white rounded-lg p-6 shadow-sm mb-6">
            <h2 className="text-3xl font-bold mb-2 text-gray-900">Terms and Conditions</h2>
          ...
          <div ref={privacySectionRef} id="privacy-section" className="bg-white rounded-lg p-6 shadow-sm">
            <h2 className="text-3xl font-bold mb-2 text-gray-900">Privacy Policy</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                <Button
                  variant="outline"
                  onClick={onClose}
                  className="px-6 text-gray-800 hover:text-red-600 border-gray-300"
                >
                  Cancel
                </Button>
                <Button
