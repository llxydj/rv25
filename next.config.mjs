      ...
      // Security headers
      {
        ...
        headers: [
          ...
          { 
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.supabase.co https://connect.facebook.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.facebook.com https://*.facebook.net; frame-src 'self' https://*.supabase.co https://*.facebook.com; object-src 'none'; base-uri 'self'; form-action 'self';" 
          },
