// @/components/layout/resident-layout.tsx
"use client"
  ...
  return (
    <AuthLayout allowedRoles={["resident"]}>
      <div className="flex h-screen bg-gray-100">
        ...
        {/* SIDEBAR */}
        <aside
          className={`fixed inset-y-0 left-0 z-30 w-64 transform bg-red-800 text-white 
        ...
        >
          ...
          <nav className="p-4 space-y-1">
            ...
            <button
              ...
              text-left bg-red-600 hover:bg-red-500 mt-4"
            >
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center space-x-2 p-2 rounded-md w-full 
              text-left hover:bg-red-700 mt-4 disabled:opacity-50"
            >
              {loading ? (
          ...
          <header className="bg-white shadow-sm z-10">
            <div className="flex items-center justify-between p-4">
              ...
              <div className="flex items-center space-x-4">
                <SystemClock className="hidden md:block text-gray-600" />

                {/* Mobile emergency button */}
                <button
                  onClick={handleEmergencyCall}
                  className="bg-red-600 text-white px-4 py-2 rounded-md flex items-center 
                  space-x-2 hover:bg-red-500 md:hidden"
                >
                  <Phone className="h-5 w-5" />
                  <span>Emergency</span>
                </button>
